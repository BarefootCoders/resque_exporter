...
var queueToWorker = map[string][]string{
	...
	"vinous":                               []string{"archive-resqueworker-all", "archive-instabot"},
	"downgrade_expired_user":               []string{"archive-resqueworker-all"},
	"sourcing":                             []string{"archive-resqueworker-instabot"},
	"post_instagram_comments":              []string{"archive-resqueworker-instabot"},
	"receive_instagram_scrape_complete":    []string{"archive-resqueworker-instabot"},
	"receive_instagram_user":               []string{"archive-resqueworker-instabot"},
	"receive_instagram_capture":            []string{"archive-resqueworker-instabot"},
	"instabot":                             []string{"archive-resqueworker-instabot"},
	"analyze_instagram_captures":           []string{"archive-resqueworker-instabot"},
